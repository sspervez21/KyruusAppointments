...
type DeleteAppointmentParams struct {
	...
	/*
	  ...
	  In: body
	*/
	DeleteAppointment *models.Appointment
}
...
func (o *DeleteAppointmentParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		...
		if err := route.Consumer.Consume(r.Body, &body); err != nil {
			if err == io.EOF {
				res = append(res, errors.Required("deleteAppointment", "body"))
			} else {
				res = append(res, errors.NewParseError("deleteAppointment", "body", "", err))
			}
		} else {
