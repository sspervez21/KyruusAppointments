...
// Validate validates this location list
func (m *LocationList) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *LocationList) validateList(formats strfmt.Registry) error {
...
func (m *LocationList) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *LocationList) UnmarshalBinary(b []byte) error {
	var res LocationList
